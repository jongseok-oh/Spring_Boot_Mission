...
public class AreaService {
    ...
    public AreaDto getNearLocation(Double latitude, Double longitude){
        AreaEntity nEntity = areaRepository.getNearLocation(latitude,longitude).get(0);
        return new AreaDto(
                nEntity.getId(),
                nEntity.getRegionMajor(),
                nEntity.getRegionMinor(),
                nEntity.getRegionPatch(),
                nEntity.getLatitude(),
                nEntity.getLongitude()
        );
    }
}
